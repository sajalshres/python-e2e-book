database = {
    ...
    "education": [
        {
            "institution": "Tribuuwan University",
            "location": "Lalitpur",
            "year": 2012,
...
class ResumeGenerator:
    """
    Class that represents a Resume generator for that database info mentioned above.
    """
    ...
    def __str__(self):
        return 'Resume of {}'.format(self._database['personal_info']['name'].title())
    ...
    def extract_skills(self):
        ...
        for skill in self._database['skills']:
            text = text + '- ' + skill + '\n'
        text = text +'\n'
        return text
    ...
    def extract_activities(self):
        text = '## Activities\n'
        for activity in self._database['activities']:
            text = text + '- ' + activity + '\n'
        text = text +'\n'
        return text
    ...
    def extract_hobbies(self):
        text = '## Hobbies\n'
        for hobby in self._database['hobbies']:
            text = text + '- ' + hobby + '\n'
        text = text +'\n'
        return text
    
    def show_resume_content(self):
        text = '# Resume \n\n'
        text = text + self.extract_personal_info()
        text = text + self.extract_objective()
        text = text + self.extract_education()
        text = text + self.extract_employement()
        text = text + self.extract_skills()
        text = text + self.extract_activities()
        text = text + self.extract_hobbies()
        print(text)
        return text
    ...
    def export_resume(self):
        ...
        with open(resume_path, 'w') as f:
            f.write(self.show_resume_content())
...
if __name__ == '__main__':
    ...
    # print(prabin.extract_education())
    # print(prabin.extract_employement())
    # print(prabin.extract_skills())
    # print(prabin.extract_activities())
    # print(prabin.extract_hobbies())
    
    # print(prabin.show_resume_content())
    prabin.export_resume()